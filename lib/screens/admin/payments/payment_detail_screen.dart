          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('DEUDA TOTAL', style: theme.textTheme.labelMedium?.copyWith(color: colorScheme.onSurfaceVariant, letterSpacing: 1.2)),
                    ...
                    const SizedBox(height: 8),
                    Text(nombreCliente, style: theme.textTheme.titleMedium?.copyWith(color: colorScheme.onSurface)),
                  ],
                ),
              ),
              ...
              if (_ticketsConDeuda.isEmpty)
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("¡Todo al día!", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                )
                ...
                Padding(
                  ...
                  child: Text('Selecciona tickets a pagar', style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold, color: Colors.grey)),
                ),
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: isSelected ? [] : [BoxShadow(color: Colors.black.withOpacity(0.03), blurRadius: 4, offset: const Offset(0, 2))],
                        ),
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(info, style: TextStyle(fontWeight: FontWeight.bold, color: isSelected ? colorScheme.primary : Colors.black87)),
                                  const SizedBox(height: 4),
                                  Text('Ticket ${_shortId(id.toString())}', style: TextStyle(fontSize: 12, color: isSelected ? colorScheme.primary.withOpacity(0.7) : Colors.grey)),
                                ],
                              ),
                            ),
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 16,
                                    color: isSelected ? colorScheme.primary : colorScheme.error,
                                  ),
                                ),
                              ],
                            ),
                ...
                // 3. INPUT Y BOTÓN
                Text('Registrar Pago', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
              ...
              if (_historialPagos.isNotEmpty) ...[
                Text('Historial reciente', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                ListView.separated(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    try {
                      ...
                      if (date != null) {
                        fechaStr = DateFormat('dd MMM, HH:mm', 'es').format(date);
                      }
                    } catch (_) {}

                    // Obtenemos ID y lo cortamos
                    final fullId = p['ticket_id']?.toString() ?? (p['ticket']?['id']?.toString());
                    ...
                    return ListTile(
                      ...
                      leading: CircleAvatar(
                        ...
                        child: const Icon(Icons.receipt, color: Colors.grey, size: 18),
                      ),
                      title: Text('Pago de Bs ${monto.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                      subtitle: Text(fechaStr, style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                      ...
                      trailing: Container(
                        ...
                        child: Text(shortTicketId, style: TextStyle(fontSize: 11, color: Colors.grey.shade700, fontFamily: 'Monospace')),
                      ),
                    );
                  },
                ),
