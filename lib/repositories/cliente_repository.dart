...
class ClienteRepository {
  ...
  Future<Map<String, dynamic>> crearCliente(
    ...
    try {
      ...
      payload['estadocliente'] =
          cliente['estadoCliente'] ?? cliente['estadocliente'] ?? true;
      payload['sucursal_id'] =
          cliente['sucursal_id'] ??
          cliente['sucursal'] ??
          cliente['sucursalId'];
  ...
  Future<Map<String, dynamic>> updateCliente(
    ...
    try {
      ...
      final payload = <String, dynamic>{};
      if (cliente.containsKey('nombreCliente') ||
          cliente.containsKey('nombrecliente'))
        payload['nombrecliente'] =
            cliente['nombreCliente'] ?? cliente['nombrecliente'];
      if (cliente.containsKey('apellidoCliente') ||
          cliente.containsKey('apellidocliente'))
        payload['apellidocliente'] =
            cliente['apellidoCliente'] ?? cliente['apellidocliente'];
      if (cliente.containsKey('telefono'))
        payload['telefono'] = cliente['telefono']?.toString();
      if (cliente.containsKey('estadoCliente') ||
          cliente.containsKey('estadocliente'))
        payload['estadocliente'] =
            cliente['estadoCliente'] ?? cliente['estadocliente'];
      if (cliente.containsKey('sucursal_id') || cliente.containsKey('sucursal'))
        payload['sucursal_id'] = cliente['sucursal_id'] ?? cliente['sucursal'];
